...
In this paper, we investigated the private coded caching scenario, where the aim is to preserve the demand privacy for all the users in the system. Specifically, our aim was to extend the 
...
This connection opens the gate between coded caching and PIR which leads to order-optimal schemes for private caching settings. 
